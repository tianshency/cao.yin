...
<body>
	<div class="main_container">
		<%-- <form action="${ctx}/releaseInfoController/releaseFoodInfo.do"  method="POST" enctype="multipart/form-data" id="form1" style="margin-bottom: 0;"> --%>
			...
			<div class="publish-article-title">
				<select id="kind">
					<option>选择粮食类型</option>
	  				<option value="1">玉米</option>
	  				<option value="2">大豆</option>
	  				<option value="3">杂豆</option>
				</select>
			</div>
	    	...
	    	<div class="publish-article-title2">
				<div class="title-tips">总量</div>
				<!-- <textarea rows="4" cols="50" id="remark" name="remark"></textarea> -->
				<input type="text"  placeholder="<c:if test="childType==1">售出总量</c:if><c:if test="childType==2">收购总量</c:if>" id="totalNum" name="totalNum">
	...
	<script src="${ctxContents}js/release/releasefoodinfo.js"></script>
</body>
</html>
