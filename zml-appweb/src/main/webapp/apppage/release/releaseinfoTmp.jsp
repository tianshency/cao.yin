...
<body>
	<div class="main_container">
		...
		<div class="publish-article-title">
			<select id="kind">
					<option>发布信息种类</option>
					<c:if test="${parentType==03 }">
		  				<option value="1">玉米收割机</option>
		  				<option value="2">大豆收割机</option>
		  				<option value="3">大型拖拉机</option>
	  				</c:if>
	  				<c:if test="${parentType==04 }">
		  				<option value="1">玉米收割机</option>
		  				<option value="2">大豆收割机</option>
		  				<option value="3">大型拖拉机</option>
	  				</c:if>
	  				<c:if test="${parentType==05 }">
		  				<option value="1">招种土豆工人</option>
		  				<option value="2">招小工</option>
		  				<option value="3">招大工</option>
	  				</c:if>
				</select>
		</div>
		<div class="publish-article-title">
	...
	<script src="${ctxContents}js/release/releaseother.js"></script>
	</script>
</body>
</html>
