...
<html>
	...
	<body>
		<div class="top_div">
				<div class="content_main" id="baseInfoDiv">
					<form class="form-horizontal" role="form">
						<div class="main_detail">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input class="form-control" id="ds_host" type="text" placeholder="请输入验证码" /><button type="button" id="inputCheckCode">60秒后重发</button>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="control-label" for="productId"><span class="text-muted">*</span>借款期限:</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label class="control-label" for="interestRate"><span class="text-muted">*</span>利率:</label>
								<div class="col-sm-4">
									<input class="form-control" id="interestRate" type="number" readonly value="${loanApplication.interestRate }"/>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label" for="interest"><span class="text-muted">*</span>利息:</label>
								<div class="col-sm-4">
									<input class="form-control" id="interest" type="number" readonly value=""  />
								</div>
							</div>			
							<div class="form-group">
				...
				<div class="content_main" id="imgUploadDiv">
					<form class="form-horizontal" role="form">
						<div class="main_detail">
							<div class="form-group">
							...
							<div class="form-group_hk">
								...
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/idc_b.jpg" id="sfb_img" class="fileimg" onclick="clickFile(this,1,'sfb',0);">
								</div>
							</div>
							<div class="form-group_hk">
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/idc_z.jpg" id="sf_img" class="fileimg" onclick="clickFile(this,1,'sf',0);">
								</div>
							</div>
							<%-- <div class="form-group">
							...
							<div class="form-group_hk">
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/jzh_z.jpg" id="fchz_img" class="fileimg" onclick="clickFile(this,3,'fchz',0);">
								</div>
							</div>
							<div class="form-group_hk">
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/jzh_z.jpg" id="fchz1_img" class="fileimg" onclick="clickFile(this,3,'fchz1',1);">
								</div>
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/jzh_z.jpg" id="fchz2_img" class="fileimg" onclick="clickFile(this,3,'fchz2',2);">
								</div>
							</div>
							<div class="form-group_hk">
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/jzh_z.jpg" id="fchz3_img" class="fileimg" onclick="clickFile(this,3,'fchz3',3);">
								</div>
								<div class="col-sm-2 controls">
									<input type="file" id="fchz4" name="upload" class="fileclass">
									<img src="${ctxContents}img/jzh_z.jpg" class="fileimg" onclick="clickFile(this,3,'fchz4',4);">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group_hk">
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/jzh_z.jpg" id="td1_img" class="fileimg" onclick="clickFile(this,2,'tdb1',0);">
								</div>
								<div class="col-sm-2 controls">
									...
									<img src="${ctxContents}img/jzh_b.jpg" id="td2_img" class="fileimg" onclick="clickFile(this,2,'tdb2',0);">
								</div>
							</div>
							<%-- <div class="form-group">
				...
				<div class="content_main" id="addContractInfoDiv" >
					<form class="form-horizontal" role="form">
						...
						<div class="main_detail">
							...
							<div class="form-group btn_other">
								<button id="save_btn" type="button">保             存</button>
							</div>
						</div>
					</form>
				</div>
				<div class="table-responsive" id="contractList">
		...
		<footer class="WaitingLoan-footer">
			<a href="javascript:void(-1);" onclick="lastStep();">上一步</a>
			<a href="javascript:void(-1);" onclick="nextStep();" id="nextbtn">下一步</a>
		</footer>
