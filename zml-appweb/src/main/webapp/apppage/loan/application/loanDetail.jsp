						...
						<form class="form-horizontal" role="form">
							<div class="main_detail">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input class="form-control" id="phone" type="text" placeholder="请输入手机号，方便我们为您服务" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label" for="amount"><span class="text-muted">*</span>借款金额:</label>
									<div class="col-sm-4">
										<input class="form-control" id="amount" type="text" placeholder="请输入借款金额" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group_hk">
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/idc_z.jpg" id="sfz_img" class="fileimg" onclick="clickFile(1,'sfz',0);" onchange="uploadFile();">
									</div>
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/idc_b.jpg" id="sfb_img" class="fileimg" onclick="clickFile(2,'sfb',0);" onchange="uploadFile();">
									</div>
								</div>
								<div class="form-group_hk">
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/idc_z.jpg" id="sf_img" class="fileimg" onclick="clickFile(3,'sf',0);" onchange="uploadFile();">
									</div>
								</div>
								<%-- <div class="form-group">
								...
								<div class="form-group_hk">
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/jzh_z.jpg" id="fchz_img" class="fileimg" onclick="clickFile(5,'fchz',0);">
									</div>
								</div>
								<div class="form-group_hk">
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/jzh_z.jpg" id="fchz1_img" class="fileimg" onclick="clickFile(6,'fchz1',1);">
									</div>
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/jzh_z.jpg" id="fchz2_img" class="fileimg" onclick="clickFile(6,'fchz2',2);">
									</div>
								</div>
								<div class="form-group_hk">
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/jzh_z.jpg" id="fchz3_img" class="fileimg" onclick="clickFile(6,'fchz3',3);">
									</div>
									<div class="col-sm-2 controls">
										<input type="file" id="fchz4" name="upload" class="fileclass">
										<img src="${ctxContents}img/jzh_z.jpg" class="fileimg" onclick="clickFile(6,'fchz4',4);">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group_hk">
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/jzh_z.jpg" id="td1_img" class="fileimg" onclick="clickFile(4,'tdb1',0);">
									</div>
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/jzh_b.jpg" id="td2_img" class="fileimg" onclick="clickFile(4,'tdb2',0);">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group_hk">
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/hk-1.jpg" id="hk1_img" class="fileimg" onclick="clickFile(4,'hk1',0);">
									</div>
									<div class="col-sm-2 controls">
										...
										<img src="${ctxContents}img/hk-2.jpg" id="hk2_img" class="fileimg" onclick="clickFile(4,'hk2',0);">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-2 controls">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<div class="btn_div">
											<button id="saveApply" type="button">完              成</button>
										</div>
									</div>
								</div>
							</div>
