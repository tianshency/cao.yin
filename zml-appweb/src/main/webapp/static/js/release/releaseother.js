...
function submitReleaseInfo(){
	urlPath=activePath+"releaseInfoController/releaseInfo.do";
	var title = $("#title").val();
	...
	$.ajaxFileUpload({
		url : urlPath,
		data : {userId:userId,title:title,remarks:content,kind:type,childType:childType,releaseType:parentType},
		type : "post",
