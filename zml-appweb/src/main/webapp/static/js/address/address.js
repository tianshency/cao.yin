...
function addAddressInfo(event){
	...
	$.ajax({
	    ...
	    url: activePath+"myUserController/addUserAddress.do",//
	    data: {isDefault:radio,consignee:encodeURI(appendName),phone:tel,address:encodeURI(appendDizhi)},//要发送的数据
