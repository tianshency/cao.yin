...
@Service("zmlUserViewHistoryService")
@Transactional
public class ZmlUserViewHistoryServiceImpl extends CommonServiceImpl implements ZmlUserViewHistoryServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZmlUserViewHistoryEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ZmlUserViewHistoryEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ZmlUserViewHistoryEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ZmlUserViewHistoryEntity t){
		...
		map.put("view_type", t.getViewType());
		map.put("data_id", t.getDataId());
		map.put("browsing_times", t.getBrowsingTimes());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZmlUserViewHistoryEntity t){
 		...
 		sql  = sql.replace("#{view_type}",String.valueOf(t.getViewType()));
 		sql  = sql.replace("#{data_id}",String.valueOf(t.getDataId()));
 		sql  = sql.replace("#{browsing_times}",String.valueOf(t.getBrowsingTimes()));
