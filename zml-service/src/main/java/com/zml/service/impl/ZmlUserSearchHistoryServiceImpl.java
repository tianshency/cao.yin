...
@Service("zmlUserSearchHistoryService")
@Transactional
public class ZmlUserSearchHistoryServiceImpl extends CommonServiceImpl implements ZmlUserSearchHistoryServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZmlUserSearchHistoryEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ZmlUserSearchHistoryEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ZmlUserSearchHistoryEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ZmlUserSearchHistoryEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZmlUserSearchHistoryEntity t){
