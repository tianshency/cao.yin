...
@Service("zmlUserPayTurnoverService")
@Transactional
public class ZmlUserPayTurnoverServiceImpl extends CommonServiceImpl implements ZmlUserPayTurnoverServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZmlUserPayTurnoverEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ZmlUserPayTurnoverEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ZmlUserPayTurnoverEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ZmlUserPayTurnoverEntity t){
		...
		map.put("pay_way", t.getPayWay());
		map.put("pay_name", t.getPayName());
		map.put("total_amount", t.getTotalAmount());
		map.put("pay_amout", t.getPayAmout());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZmlUserPayTurnoverEntity t){
