...
@Service("zmlLoanEstateInfoService")
@Transactional
public class ZmlLoanEstateInfoServiceImpl extends CommonServiceImpl implements ZmlLoanEstateInfoServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZmlLoanEstateInfoEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ZmlLoanEstateInfoEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ZmlLoanEstateInfoEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ZmlLoanEstateInfoEntity t){
		...
		map.put("estate_type", t.getEstateType());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZmlLoanEstateInfoEntity t){
 		...
 		sql  = sql.replace("#{estate_type}",String.valueOf(t.getEstateType()));
