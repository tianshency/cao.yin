...
@Service("zmlLoanCollectionRecordService")
@Transactional
public class ZmlLoanCollectionRecordServiceImpl extends CommonServiceImpl implements ZmlLoanCollectionRecordServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZmlLoanCollectionRecordEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ZmlLoanCollectionRecordEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ZmlLoanCollectionRecordEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ZmlLoanCollectionRecordEntity t){
		...
		map.put("operator_id", t.getOperatorId());
		map.put("collection_date", t.getCollectionDate());
		map.put("collection_way", t.getCollectionWay());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZmlLoanCollectionRecordEntity t){
 		...
 		sql  = sql.replace("#{collection_date}",String.valueOf(t.getCollectionDate()));
 		sql  = sql.replace("#{collection_way}",String.valueOf(t.getCollectionWay()));
