...
@Service("zmlRiskModeConfigService")
@Transactional
public class ZmlRiskModeConfigServiceImpl extends CommonServiceImpl implements ZmlRiskModeConfigServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZmlRiskModeConfigEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ZmlRiskModeConfigEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ZmlRiskModeConfigEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ZmlRiskModeConfigEntity t){
		...
		map.put("classification", t.getClassification());
		map.put("subdivided", t.getSubdivided());
		map.put("ranges", t.getRanges());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZmlRiskModeConfigEntity t){
 		...
 		sql  = sql.replace("#{classification}",String.valueOf(t.getClassification()));
 		sql  = sql.replace("#{subdivided}",String.valueOf(t.getSubdivided()));
 		sql  = sql.replace("#{ranges}",String.valueOf(t.getRanges()));
