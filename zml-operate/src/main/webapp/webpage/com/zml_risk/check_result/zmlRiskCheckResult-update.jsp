...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlRiskCheckResultController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="result" name="result" type="text" style="width: 150px" class="inputxt"  value='${zmlRiskCheckResultPage.result}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remarkes" style="width:600px;" class="inputxt" rows="6" name="remarkes">${zmlRiskCheckResultPage.remarkes}</textarea>
							<span class="Validform_checktip"></span>
