...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="wrwTaskInfoController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  datatype="*" value='${wrwTaskInfoPage.name}'>
			...
			<td class="value">
		     	 <input id="amout" name="amout" type="text" style="width: 150px" class="inputxt"  datatype="*n" value='${wrwTaskInfoPage.amout}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="startDate" name="startDate" type="text" style="width: 150px" 
		      						 class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  datatype="*" value='<fmt:formatDate value='${wrwTaskInfoPage.startDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="endDate" name="endDate" type="text" style="width: 150px" 
		      						 class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  datatype="*" value='<fmt:formatDate value='${wrwTaskInfoPage.endDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="status" type="list"
						typeGroupCode="" defaultVal="${wrwTaskInfoPage.status}" hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				 <textarea id="remark" style="width:600px;" class="inputxt" rows="6" name="remark">${wrwTaskInfoPage.remark}</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="laveAmout" name="laveAmout" type="text" style="width: 150px" class="inputxt" value='${wrwTaskInfoPage.laveAmout}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="taskUrl" name="taskUrl" type="text" style="width: 150px" class="inputxt" value='${wrwTaskInfoPage.taskUrl}'>
				<span class="Validform_checktip"></span>
