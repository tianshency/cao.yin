...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlLoanProductController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="version" name="version" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanProductPage.version}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="proName" name="proName" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanProductPage.proName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="interestRate" name="interestRate" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanProductPage.interestRate}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="penaltyRate" name="penaltyRate" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanProductPage.penaltyRate}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="minAmount" name="minAmount" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanProductPage.minAmount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="maxAmount" name="maxAmount" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanProductPage.maxAmount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="details" name="details" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanProductPage.details}'>
							<span class="Validform_checktip"></span>
