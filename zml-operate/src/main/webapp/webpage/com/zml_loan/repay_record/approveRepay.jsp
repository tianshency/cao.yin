...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlLoanWfTaskController.do?doApproveRepay" tiptype="1" callback="jeecgFormFileCallBack@Override">
			<input id="id" name="id" type="hidden" value="${wfId}">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="approvalAmt" name="approvalAmt" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanRepayRecordPage.repayAmt}'>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">审批金额</label>
						</td>
					</tr>
					<tr>
						<td align="right">
