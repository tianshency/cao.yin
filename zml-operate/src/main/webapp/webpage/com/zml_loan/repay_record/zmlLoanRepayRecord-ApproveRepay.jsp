...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlLoanRepayRecordController.do?doApproveRepay" tiptype="1" callback="jeecgFormFileCallBack@Override">
