...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlLoanUserContactsController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanUserContactsPage.name}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  datatype="m" value='${zmlLoanUserContactsPage.phone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="profession" name="profession" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanUserContactsPage.profession}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="work" name="work" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanUserContactsPage.work}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNumber" name="idNumber" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanUserContactsPage.idNumber}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="age" name="age" type="text" style="width: 150px" class="inputxt"  datatype="3n" value='${zmlLoanUserContactsPage.age}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="address" name="address" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanUserContactsPage.address}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="seqNo" name="seqNo" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlLoanUserContactsPage.seqNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="approvalDate" name="approvalDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${zmlLoanUserContactsPage.approvalDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="approvalOpinion" name="approvalOpinion" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanUserContactsPage.approvalOpinion}'>
							<span class="Validform_checktip"></span>
