...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlUserSearchHistoryController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="content" style="width:600px;" class="inputxt" rows="6" name="content">${zmlUserSearchHistoryPage.content}</textarea>
							<span class="Validform_checktip"></span>
