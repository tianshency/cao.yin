...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlUserReleaseTerritoryController.do?doApproval" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					    <input id="type" name="type" type="text" style="width: 150px" class="inputxt"  value='${zmlUserReleaseTerritoryPage.type}'>
					...
					<td class="value">
					    <input id="title" name="title" type="text" style="width: 150px" class="inputxt"  value='${zmlUserReleaseTerritoryPage.title}'>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="position" name="position" type="text" style="width: 150px" class="inputxt"  value='${zmlUserReleaseTerritoryPage.position}'>
						<span class="Validform_checktip"></span>
					...
					<td class="value">
					      		<input id="coverImg" name="coverImg" type="text" style="width: 150px" class="inputxt"   value='${zmlUserReleaseTerritoryPage.coverImg}'>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="area" name="area" type="text" style="width: 150px" class="inputxt"  value='${zmlUserReleaseTerritoryPage.area}'>
						<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="price" name="price" type="text" style="width: 150px" class="inputxt"  value='${zmlUserReleaseTerritoryPage.price}'>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						<input id="validStartDate" name="validStartDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${zmlUserReleaseTerritoryPage.validStartDate}' type="date" pattern="yyyy-MM-dd"/>'>
						<span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="validEndDate" name="validEndDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${zmlUserReleaseTerritoryPage.validEndDate}' type="date" pattern="yyyy-MM-dd"/>'>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					    <input id="remarks" name="remarks" type="text" style="width: 150px" class="inputxt"  value='${zmlUserReleaseTerritoryPage.remarks}'>
						<span class="Validform_checktip"></span>
