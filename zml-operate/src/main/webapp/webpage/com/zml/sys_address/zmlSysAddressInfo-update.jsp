...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlSysAddressInfoController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="userId" name="userId" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.userId}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="addrPrecision" name="addrPrecision" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.addrPrecision}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="addrLatitude" name="addrLatitude" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.addrLatitude}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="addressName" style="width:600px;" class="inputxt" rows="6" name="addressName">${zmlSysAddressInfoPage.addressName}</textarea>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="province" name="province" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.province}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="city" name="city" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.city}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="county" name="county" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.county}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="village" name="village" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.village}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="groupName" name="groupName" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.groupName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="tuenName" name="tuenName" type="text" style="width: 150px" class="inputxt"  value='${zmlSysAddressInfoPage.tuenName}'>
							<span class="Validform_checktip"></span>
