...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlTestController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  value='${zmlTestPage.name}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="age" name="age" type="text" style="width: 150px" class="inputxt"  value='${zmlTestPage.age}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  value='${zmlTestPage.phone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="email" name="email" type="text" style="width: 150px" class="inputxt"  value='${zmlTestPage.email}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						      		<input id="touxiang" name="touxiang" type="text" style="width: 150px" class="inputxt"   value='${zmlTestPage.touxiang}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="jianli" name="jianli" type="text" style="width: 150px" class="inputxt"  value='${zmlTestPage.jianli}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  value='${zmlTestPage.remark}'>
							<span class="Validform_checktip"></span>
