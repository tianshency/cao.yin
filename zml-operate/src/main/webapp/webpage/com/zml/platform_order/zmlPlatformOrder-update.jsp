...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zmlPlatformOrderController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					<t:dictSelect field="sellerId" type="list"
						dictTable="zml_merchants" dictField="id" dictText="merchants_name" defaultVal="${zmlPlatformOrderPage.sellerId}" hasLabel="false"  title="商家"></t:dictSelect>     
			...
			<td class="value">
		     	 <input id="porderNum" name="porderNum" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.porderNum}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="allAmount" name="allAmount" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.allAmount}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="payWay" type="list"
						typeGroupCode="p_pay_way" defaultVal="${zmlPlatformOrderPage.payWay}" hasLabel="false"  title="支付方式"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="payVoucher" name="payVoucher" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.payVoucher}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="invoiceType" type="list"
						typeGroupCode="invoice_type" defaultVal="${zmlPlatformOrderPage.invoiceType}" hasLabel="false"  title="发票类型"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="invoiceTitle" type="list"
						typeGroupCode="invoice_title" defaultVal="${zmlPlatformOrderPage.invoiceTitle}" hasLabel="false"  title="发票抬头"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="invoiceContent" type="list"
						typeGroupCode="invoice_content" defaultVal="${zmlPlatformOrderPage.invoiceContent}" hasLabel="false"  title="发票内容"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="status" type="list"
						typeGroupCode="p_order_sts" defaultVal="${zmlPlatformOrderPage.status}" hasLabel="false"  title="订单状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="isReturns" type="list"
						typeGroupCode="is_returns" defaultVal="${zmlPlatformOrderPage.isReturns}" hasLabel="false"  title="是否退货"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="returnReason" name="returnReason" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.returnReason}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="orderTime" name="orderTime" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${zmlPlatformOrderPage.orderTime}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="payTime" name="payTime" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${zmlPlatformOrderPage.payTime}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="remarks" name="remarks" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.remarks}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="address" name="address" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.address}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="logisticsCompany" name="logisticsCompany" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.logisticsCompany}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="logisticsNum" name="logisticsNum" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.logisticsNum}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="logisticsFee" name="logisticsFee" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlPlatformOrderPage.logisticsFee}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="logisticsLinkPerson" name="logisticsLinkPerson" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.logisticsLinkPerson}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="logisticsLinkPhnoe" name="logisticsLinkPhnoe" type="text" style="width: 150px" class="inputxt" value='${zmlPlatformOrderPage.logisticsLinkPhnoe}'>
				<span class="Validform_checktip"></span>
