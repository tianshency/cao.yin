...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="cfUserController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  datatype="*" value='${cfUserPage.name}'>
			...
			<td class="value">
		     	 <input id="nickname" name="nickname" type="text" style="width: 150px" class="inputxt" value='${cfUserPage.nickname}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  datatype="m" value='${cfUserPage.phone}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="type" type="list"
						typeGroupCode="user_type" defaultVal="${cfUserPage.type}" hasLabel="false"  title="用户类型"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="locked" type="list"
						typeGroupCode="user_locked" defaultVal="${cfUserPage.locked}" hasLabel="false"  title="用户状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
