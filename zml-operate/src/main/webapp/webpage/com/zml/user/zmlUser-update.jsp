...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zmlUserController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="userName" name="userName" type="text" style="width: 150px" class="inputxt"  datatype="*" value='${zmlUserPage.userName}'>
			...
			<td class="value">
		     	 <input id="nickname" name="nickname" type="text" style="width: 150px" class="inputxt" value='${zmlUserPage.nickname}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  datatype="m" value='${zmlUserPage.phone}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="realName" name="realName" type="text" style="width: 150px" class="inputxt" value='${zmlUserPage.realName}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="identificationNumber" name="identificationNumber" type="text" style="width: 150px" class="inputxt" value='${zmlUserPage.identificationNumber}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="age" name="age" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlUserPage.age}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="sex" type="list"
						typeGroupCode="sex" defaultVal="${zmlUserPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="type" type="list"
						typeGroupCode="user_type" defaultVal="${zmlUserPage.type}" hasLabel="false"  title="用户类型"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="isVerified" type="list"
						typeGroupCode="sf_yn" defaultVal="${zmlUserPage.isVerified}" hasLabel="false"  title="是否实名认证"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="locked" type="list"
						typeGroupCode="user_locked" defaultVal="${zmlUserPage.locked}" hasLabel="false"  title="当前帐号是否禁用"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="registrationAgreement" type="list"
						typeGroupCode="sf_yn" defaultVal="${zmlUserPage.registrationAgreement}" hasLabel="false"  title="是否签订注册协议"></t:dictSelect>     
				<span class="Validform_checktip"></span>
