...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlMerchantsController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="merchantsName" name="merchantsName" type="text" style="width: 150px" class="inputxt"  datatype="*">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="merchantsAdress" name="merchantsAdress" type="text" style="width: 150px" class="inputxt"  datatype="*">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="merchantsDescription" name="merchantsDescription" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="businesslicense" name="businesslicense" type="text" style="width: 150px" class="inputxt"  datatype="*">
							<span class="Validform_checktip"></span>
...
>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="consumerHotline" name="consumerHotline" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="leaderTelephone" name="leaderTelephone" type="text" style="width: 150px" class="inputxt"  datatype="m">
							<span class="Validform_checktip"></span>
