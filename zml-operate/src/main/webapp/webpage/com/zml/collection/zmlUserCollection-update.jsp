...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlUserCollectionController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="label" name="label" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionPage.label}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="collectionType" name="collectionType" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionPage.collectionType}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="dataId" name="dataId" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionPage.dataId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="dataName" name="dataName" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionPage.dataName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="url" name="url" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionPage.url}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remarks" style="width:600px;" class="inputxt" rows="6" name="remarks">${zmlUserCollectionPage.remarks}</textarea>
							<span class="Validform_checktip"></span>
