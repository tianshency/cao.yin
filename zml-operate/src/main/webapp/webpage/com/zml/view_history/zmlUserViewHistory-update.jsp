...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlUserViewHistoryController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="concernType" name="concernType" type="text" style="width: 150px" class="inputxt"  value='${zmlUserViewHistoryPage.concernType}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="commodityId" name="commodityId" type="text" style="width: 150px" class="inputxt"  value='${zmlUserViewHistoryPage.commodityId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="browsingTimes" name="browsingTimes" type="text" style="width: 150px" class="inputxt"  value='${zmlUserViewHistoryPage.browsingTimes}'>
							<span class="Validform_checktip"></span>
