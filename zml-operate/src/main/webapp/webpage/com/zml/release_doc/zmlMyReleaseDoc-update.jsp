...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlMyReleaseDocController.do?doUpdate" tiptype="1" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="releaseId" name="releaseId" type="text" style="width: 150px" class="inputxt"  value='${zmlMyReleaseDocPage.releaseId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						      		<input id="imagePath" name="imagePath" type="text" style="width: 150px" class="inputxt"   value='${zmlMyReleaseDocPage.imagePath}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="details" name="details" type="text" style="width: 150px" class="inputxt"  value='${zmlMyReleaseDocPage.details}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/zml/release_doc/zmlMyReleaseDoc.js"></script>		
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "zmlMyReleaseDocController.do?getFiles&id=" +  cgFormId,
