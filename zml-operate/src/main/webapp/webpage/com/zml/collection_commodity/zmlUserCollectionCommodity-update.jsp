...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlUserCollectionCommodityController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="label" name="label" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionCommodityPage.label}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="price" name="price" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionCommodityPage.price}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="url" name="url" type="text" style="width: 150px" class="inputxt"  value='${zmlUserCollectionCommodityPage.url}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remarks" style="width:600px;" class="inputxt" rows="6" name="remarks">${zmlUserCollectionCommodityPage.remarks}</textarea>
							<span class="Validform_checktip"></span>
