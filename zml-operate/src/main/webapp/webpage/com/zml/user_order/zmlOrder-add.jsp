...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zmlOrderController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					<t:dictSelect field="buyersId" type="list"
						dictTable="zml_user" dictField="id" dictText="user_name"  hasLabel="false"  title="买家"></t:dictSelect>     
		...
		<tr>
			...
			<td class="value">
		     	 <input id="payId" name="payId" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="status" type="list"
						typeGroupCode="u_order_sts"  hasLabel="false"  title="订单状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="platformRemarks" name="platformRemarks" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="payAmout" name="payAmout" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="userRemarks" name="userRemarks" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="addressId" type="list"
						dictTable="zml_user_address" dictField="id" dictText="address"  hasLabel="false"  title="收货地址"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="logisticsFee" name="logisticsFee" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="zmlOrderController.do?zmlOrderCommodityList&oRDER_NUM=${zmlOrderPage.oRDER_NUM}" icon="icon-search" title="订单商品" id="zmlOrderCommodity"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
	...
	<tbody id="add_zmlOrderCommodity_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="zmlOrderCommodityList[#index#].commodityName" maxlength="200" 
				  ...
				  <td align="left">
					  	<input name="zmlOrderCommodityList[#index#].commodityType" maxlength="36" 
					  		type="text" class="inputxt"  style="width:120px;" >
 ...
 <script src = "webpage/com/zml/user_order/zmlOrder.js"></script>
