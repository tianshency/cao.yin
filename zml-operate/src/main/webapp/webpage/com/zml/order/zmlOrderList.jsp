...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zmlOrderList" checkbox="true" fitColumns="false" title="订单" actionUrl="zmlOrderController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="买家"  field="buyersId"   query="true" queryMode="single" dictionary="zml_user,id,user_name"  width="120"></t:dgCol>
   <t:dgCol title="商家"  field="merchantsId"   query="true" queryMode="single" dictionary="t_s_depart,org_code,departname"  width="120"></t:dgCol>
   ...
   <t:dgCol title="订单状态"  field="status"   query="true" queryMode="single" dictionary="u_order_sts" width="120"></t:dgCol>
   <t:dgCol title="平台备注"  field="platformRemarks"   query="true" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="订单金额"  field="allAmount"   query="true" queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="实际付款金额"  field="payAmout"   query="true" queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgCol title="物流联系人"  field="logisticsLinkPerson"   query="true" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="物流联系人电话"  field="logisticsLinkPhnoe"   query="true" queryMode="single"  width="120"></t:dgCol>
 ...
 <script src = "webpage/com/zml/order/zmlOrderList.js"></script>		
