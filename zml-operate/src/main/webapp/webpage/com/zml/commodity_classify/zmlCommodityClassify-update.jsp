...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlCommodityClassifyController.do?doUpdate" tiptype="1" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="classifyCode" name="classifyCode" type="text" style="width: 150px" class="inputxt"  value='${zmlCommodityClassifyPage.classifyCode}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  value='${zmlCommodityClassifyPage.name}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="introduction" name="introduction" type="text" style="width: 150px" class="inputxt"  value='${zmlCommodityClassifyPage.introduction}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="orderNum" name="orderNum" type="text" style="width: 150px" class="inputxt"  value='${zmlCommodityClassifyPage.orderNum}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/zml/commodity_classify/zmlCommodityClassify.js"></script>		
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "zmlCommodityClassifyController.do?getFiles&id=" +  cgFormId,
