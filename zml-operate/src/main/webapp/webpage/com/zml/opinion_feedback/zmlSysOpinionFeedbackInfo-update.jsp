...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlSysOpinionFeedbackInfoController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="userId" name="userId" type="text" style="width: 150px" class="inputxt"  value='${zmlSysOpinionFeedbackInfoPage.userId}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="title" name="title" type="text" style="width: 150px" class="inputxt"  value='${zmlSysOpinionFeedbackInfoPage.title}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  datatype="m" value='${zmlSysOpinionFeedbackInfoPage.phone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						      		<input id="imgOne" name="imgOne" type="text" style="width: 150px" class="inputxt"   value='${zmlSysOpinionFeedbackInfoPage.imgOne}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						      		<input id="imgTwo" name="imgTwo" type="text" style="width: 150px" class="inputxt"   value='${zmlSysOpinionFeedbackInfoPage.imgTwo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						      		<input id="imgThree" name="imgThree" type="text" style="width: 150px" class="inputxt"   value='${zmlSysOpinionFeedbackInfoPage.imgThree}'>
							<span class="Validform_checktip"></span>
