...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlCropPlanController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="openId" name="openId" type="text" style="width: 150px" class="inputxt"  value='${zmlCropPlanPage.openId}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="userId" name="userId" type="text" style="width: 150px" class="inputxt"  value='${zmlCropPlanPage.userId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="cropType" name="cropType" type="text" style="width: 150px" class="inputxt"  value='${zmlCropPlanPage.cropType}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="landAmout" name="landAmout" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlCropPlanPage.landAmout}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="useCommodityId" name="useCommodityId" type="text" style="width: 150px" class="inputxt"  value='${zmlCropPlanPage.useCommodityId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="calcCommodityAmout" name="calcCommodityAmout" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlCropPlanPage.calcCommodityAmout}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="realCommodityAmout" name="realCommodityAmout" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlCropPlanPage.realCommodityAmout}'>
							<span class="Validform_checktip"></span>
