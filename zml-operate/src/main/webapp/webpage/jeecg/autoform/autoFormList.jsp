...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="autoFormList" checkbox="true" fitColumns="false" title="自定义表单列表" actionUrl="autoFormController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="updateDate" sortOrder="desc">
