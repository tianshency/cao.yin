 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="productUnit" name="productUnit" type="text" style="width: 150px" class="inputxt"  value='${goodsPage.productUnit}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="productOwner" name="productOwner" type="text" style="width: 150px" class="inputxt"  value='${goodsPage.productOwner}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="timeToMarket" name="timeToMarket" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${goodsPage.timeToMarket}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/sys/demo/goods/goods.js"></script>		
