...
<head>
    ...
    <title><t:mutiLang langKey="zml.platform"/></title>

    <meta name="keywords" content="助民乐后台管理系统">
    <meta name="description" content="助民乐后台管理系统:日常运维操作，贷款管理">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="plug-in/login/images/zml-logo.png" /></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <!-- <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="您已进入助民乐后台管理系统…" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form> -->
                    <div class="form-group">
                                               您已进入助民乐后台管理系统…
        ...
        <div class="footer">
            <div class="pull-right">&copy; <t:mutiLang langKey="system.version.number"/> 助民乐
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
