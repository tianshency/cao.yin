 ...
 */
@Controller
@RequestMapping("/wrwRegisteredLogController")
public class WrwRegisteredLogController extends BaseController {
	/**
	...
	public AjaxJson doBatchDel(String ids,HttpServletRequest request){
		...
		try{
			for(String id:ids.split(",")){
				WrwRegisteredLogEntity wrwRegisteredLog = systemService.getEntity(WrwRegisteredLogEntity.class, 
				id
				);
				wrwRegisteredLogService.delete(wrwRegisteredLog);
	...
	@ResponseBody
	public AjaxJson doAdd(WrwRegisteredLogEntity wrwRegisteredLog, HttpServletRequest request) {
		String message = null;
		AjaxJson j = new AjaxJson();
		message = "注册日志添加成功";
		try{
			wrwRegisteredLogService.save(wrwRegisteredLog);
			systemService.addLog("/wrwRegisteredLogController/doAdd", "", message, Globals.Log_Type_INSERT, Globals.Log_Leavel_INFO);
		}catch(Exception e){
			e.printStackTrace();
			message = "注册日志添加失败";
			throw new BusinessException(e.getMessage());
