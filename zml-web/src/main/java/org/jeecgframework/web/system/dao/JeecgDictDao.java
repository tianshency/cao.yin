...
public interface JeecgDictDao {
	 ...
	 * 返回类型： List<DictEntity>
	 */
	@Arguments({"dicTable", "dicCode", "dicText", "dicParam"})
	@ResultType(DictEntity.class)
	public List<DictEntity> queryCustomDictByParam(String dicTable, String dicCode,String dicText,String dicParam);
