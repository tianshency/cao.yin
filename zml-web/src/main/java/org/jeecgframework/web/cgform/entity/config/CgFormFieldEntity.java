...
public class CgFormFieldEntity implements java.io.Serializable {
	...
	// bobo 字典 查询 条件参数
	private java.lang.String  dictParam ;
	...
	//bobo
	@Column(name ="dict_param",nullable=true,length=500)
	public java.lang.String getDictParam() {
		return dictParam;
	}

	public void setDictParam(java.lang.String dictParam) {
