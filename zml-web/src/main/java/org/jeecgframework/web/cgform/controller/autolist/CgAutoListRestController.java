...
//			}
	...
	private void loadDic(Map m, CgFormFieldEntity bean) {
		...
		String dicParam = bean.getDictParam();
		...
		if(!bean.getShowType().equals("popup")){
			//bobo2016-06-25 List<DictEntity> dicDatas = queryDic(dicT, dicF,dicText);
			List<DictEntity> dicDatas = queryDicByParam(dicT, dicF,dicText, dicParam);
