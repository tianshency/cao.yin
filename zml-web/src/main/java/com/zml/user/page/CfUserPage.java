 ...
 *
 */
public class CfUserPage implements java.io.Serializable {
	/**主键*/
	...
	private List<CfUserAddressEntity> cfUserAddressList = new ArrayList<CfUserAddressEntity>();
		public List<CfUserAddressEntity> getCfUserAddressList() {
		return cfUserAddressList;
		}
		public void setCfUserAddressList(List<CfUserAddressEntity> cfUserAddressList) {
		this.cfUserAddressList = cfUserAddressList;
		}
}
