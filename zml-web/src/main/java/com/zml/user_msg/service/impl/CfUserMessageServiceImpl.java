package com.zml.user_msg.service.impl;
...
@Service("cfUserMessageService")
@Transactional
public class CfUserMessageServiceImpl extends CommonServiceImpl implements CfUserMessageServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(CfUserMessageEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(CfUserMessageEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(CfUserMessageEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(CfUserMessageEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,CfUserMessageEntity t){
