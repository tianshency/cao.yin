package com.zml.user_msg.entity;
 ...
 */
@Entity
@Table(name = "zml_user_message", schema = "")
@SuppressWarnings("serial")
public class CfUserMessageEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="CONTEN",nullable=true,length=500)
