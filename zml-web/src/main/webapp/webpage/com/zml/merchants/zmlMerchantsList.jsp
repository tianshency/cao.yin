...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zmlMerchantsList" checkbox="true" fitColumns="false" title="商户信息" actionUrl="zmlMerchantsController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="商户名称"  field="merchantsName"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="商家地址"  field="merchantsAdress"    queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="评级"  field="grade"    queryMode="single" dictionary="merchants_grade" width="120"></t:dgCol>
