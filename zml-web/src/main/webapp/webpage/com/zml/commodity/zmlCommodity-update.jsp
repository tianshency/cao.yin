...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zmlCommodityController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt" value='${zmlCommodityPage.name}'>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="totalAmount" name="totalAmount" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlCommodityPage.totalAmount}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="amountUnit" type="list"
						typeGroupCode="amount_unit" defaultVal="${zmlCommodityPage.amountUnit}" hasLabel="false"  title="数量单位"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="commercialSpecification" type="list"
						typeGroupCode="specification" defaultVal="${zmlCommodityPage.commercialSpecification}" hasLabel="false"  title="商品规格"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="specificationWeight" name="specificationWeight" type="text" style="width: 150px" class="inputxt" value='${zmlCommodityPage.specificationWeight}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="price" name="price" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlCommodityPage.price}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="realPrice" name="realPrice" type="text" style="width: 150px" class="inputxt" value='${zmlCommodityPage.realPrice}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="productionDate" name="productionDate" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${zmlCommodityPage.productionDate}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="periodOfValidity" name="periodOfValidity" type="text" style="width: 150px" class="inputxt"  datatype="n" value='${zmlCommodityPage.periodOfValidity}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="povUnit" type="list"
						typeGroupCode="" defaultVal="${zmlCommodityPage.povUnit}" hasLabel="false"  title="有效期单位"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="isRecommend" type="list"
						typeGroupCode="is_default" defaultVal="${zmlCommodityPage.isRecommend}" hasLabel="false"  title="是否推荐"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="isHot" type="list"
						typeGroupCode="is_default" defaultVal="${zmlCommodityPage.isHot}" hasLabel="false"  title="是否热卖"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="classifyOneLevel" type="list"
						dictTable="zml_commodity_classify" dictField="id" dictText="name" defaultVal="${zmlCommodityPage.classifyOneLevel}" hasLabel="false"  title="一级分类"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="classifyTwoLevel" type="list"
						dictTable="zml_commodity_classify" dictField="id" dictText="name" defaultVal="${zmlCommodityPage.classifyTwoLevel}" hasLabel="false"  title="二级分类"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="status" type="list"
						typeGroupCode="commodity_sts" defaultVal="${zmlCommodityPage.status}" hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fare" name="fare" type="text" style="width: 150px" class="inputxt" value='${zmlCommodityPage.fare}'>
				<span class="Validform_checktip"></span>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="zmlCommodityController.do?zmlCommodityDocList&id=${zmlCommodityPage.id}" icon="icon-search" title="文档" id="zmlCommodityDoc"></t:tab>
