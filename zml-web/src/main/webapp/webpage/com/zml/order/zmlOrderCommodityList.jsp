		...
		<c:forEach items="${zmlOrderCommodityList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
					...
					<input name="zmlOrderCommodityList[${stuts.index }].merchantsId" type="hidden" value="${poVal.merchantsId }"/>
					<input name="zmlOrderCommodityList[${stuts.index }].commodityName" type="hidden" value="${poVal.commodityName }"/>
					<input name="zmlOrderCommodityList[${stuts.index }].commodityCoverImg" type="hidden" value="${poVal.commodityCoverImg }"/>
					<input name="zmlOrderCommodityList[${stuts.index }].merchantsName" type="hidden" value="${poVal.merchantsName }"/>
					<input name="zmlOrderCommodityList[${stuts.index }].merchantsLogo" type="hidden" value="${poVal.merchantsLogo }"/>
					<input name="zmlOrderCommodityList[${stuts.index }].orderId" type="hidden" value="${poVal.orderId }"/>
				   <td align="left">
				   ...
				   <td align="left">
							<t:dictSelect field="zmlOrderCommodityList[${stuts.index }].commodityType" type="list"
										dictTable="zml_commodity_classify" dictField="id" dictText="name" defaultVal="${poVal.commodityType }" hasLabel="false"  title="商品类型"></t:dictSelect>     
