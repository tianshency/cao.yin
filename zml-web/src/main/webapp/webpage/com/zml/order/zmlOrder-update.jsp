		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="merchantsId" type="list"
						dictTable="t_s_depart" dictField="id" dictText="departname" defaultVal="${zmlOrderPage.merchantsId}" hasLabel="false"  title="商家"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="zmlOrderController.do?zmlOrderCommodityList&id=${zmlOrderPage.id}" icon="icon-search" title="商品详情" id="zmlOrderCommodity"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
