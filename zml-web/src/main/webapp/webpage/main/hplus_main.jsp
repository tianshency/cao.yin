...
<head>
    ...
    <meta name="keywords" content="汽车配件商城">
    <meta name="description" content="汽车配件商城">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="plug-in/login/images/jce-logo.png" /></span>
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <!-- <input type="text" placeholder="欢迎使用汽车配件商城后台系统 …" class="form-control" name="top-search" id="top-search"> -->
                        </div>
                    </form>
                </div>
