      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            <h1 id="id-text2" class="grey">
              <i class="ace-icon fa fa-leaf green"></i>
               <t:mutiLang langKey="zml.platform"/>
            </h1>
            <h4 class="blue" id="id-company-text">www.zhuminle.com</h4>
          </div>
          ...
          <div class="position-relative">
            ...
            <div class="center"><h4 class="blue" id="id-company-text">&copy; <t:mutiLang langKey="zml.platform"/>V1.0</h4></div>
