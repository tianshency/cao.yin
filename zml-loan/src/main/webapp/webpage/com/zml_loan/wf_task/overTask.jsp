...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zmlLoanWfTaskList" checkbox="true" fitColumns="false" title="已办任务列表" actionUrl="zmlLoanWfTaskController.do?datagrid&flag=2" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="zmlLoanWfTaskController.do?goAdd" funname="add"></t:dgToolBar>--%>
    <t:dgToolBar funname="goShowApplyApprove()" title="查看"></t:dgToolBar>
...
function goApplyApprove(){
	...
	alert(bizId + "===" + wfId);
	var url = "zmlLoanApplicationController.do?goApplyApprove&bizId="+bizId+"&wfId="+wfId;
