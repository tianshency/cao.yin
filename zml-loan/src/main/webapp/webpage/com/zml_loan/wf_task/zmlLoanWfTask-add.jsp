...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlLoanWfTaskController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="taskSubject" name="taskSubject" type="text" style="width: 150px" class="inputxt"  datatype="*">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="approvalAmt" name="approvalAmt" type="text" style="width: 150px" class="inputxt"  datatype="n">
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="approvalInterestRate" name="approvalInterestRate" type="text" style="width: 150px" class="inputxt"  datatype="n">
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="approvalTerm" name="approvalTerm" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
...
>
				...
				<tr>
					...
					<td class="value">
						  	 <textarea style="width:600px;" class="inputxt" rows="6" id="approvalOpinion" name="approvalOpinion"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						  	 <textarea style="width:600px;" class="inputxt" rows="6" id="noticContent" name="noticContent"></textarea>
							<span class="Validform_checktip"></span>
