...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlLoanRiskCreditController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="creditSubjet" name="creditSubjet" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanRiskCreditPage.creditSubjet}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="assessStartTime" name="assessStartTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${zmlLoanRiskCreditPage.assessStartTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="assessEndTime" name="assessEndTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${zmlLoanRiskCreditPage.assessEndTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="assessAmt" name="assessAmt" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanRiskCreditPage.assessAmt}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remarks" style="width:600px;" class="inputxt" rows="6" name="remarks">${zmlLoanRiskCreditPage.remarks}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="approvalDate" name="approvalDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${zmlLoanRiskCreditPage.approvalDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="approvalOpinion" name="approvalOpinion" type="text" style="width: 150px" class="inputxt"  value='${zmlLoanRiskCreditPage.approvalOpinion}'>
							<span class="Validform_checktip"></span>
