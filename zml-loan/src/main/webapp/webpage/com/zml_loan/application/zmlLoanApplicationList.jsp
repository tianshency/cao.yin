...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zmlLoanApplicationList" checkbox="true" fitColumns="false" title="借款申请表" actionUrl="zmlLoanApplicationController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="编辑" icon="icon-edit" url="zmlLoanApplicationController.do?goUpdate" funname="update"></t:dgToolBar>
   <%-- <t:dgToolBar title="批量删除"  icon="icon-remove" url="zmlLoanApplicationController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar> --%>
   <t:dgToolBar title="查看" icon="icon-search" url="zmlLoanApplicationController.do?goUpdate" funname="detail"></t:dgToolBar>
