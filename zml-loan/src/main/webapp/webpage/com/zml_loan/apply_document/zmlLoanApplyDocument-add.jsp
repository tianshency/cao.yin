...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zmlLoanApplyDocumentController.do?doAdd" tiptype="1" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="seqNo" name="seqNo" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
