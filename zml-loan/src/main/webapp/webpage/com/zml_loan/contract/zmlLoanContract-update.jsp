...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zmlLoanContractController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="contractNo" name="contractNo" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.contractNo}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="creditAmt" name="creditAmt" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.creditAmt}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="contractAmt" name="contractAmt" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.contractAmt}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="contractBalance" name="contractBalance" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.contractBalance}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fee" name="fee" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.fee}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="intermediaries" name="intermediaries" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.intermediaries}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="lender" name="lender" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.lender}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="interestRate" name="interestRate" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.interestRate}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="penaltyRate" name="penaltyRate" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.penaltyRate}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="contractPath" name="contractPath" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.contractPath}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="startTime" name="startTime" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${zmlLoanContractPage.startTime}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="endTime" name="endTime" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${zmlLoanContractPage.endTime}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="overTime" name="overTime" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.overTime}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="overDays" name="overDays" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.overDays}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="imposeInterest" name="imposeInterest" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.imposeInterest}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="penalty" name="penalty" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.penalty}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="status" type="list"
						typeGroupCode="contract_sts" defaultVal="${zmlLoanContractPage.status}" hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="repayStatus" type="list"
						typeGroupCode="" defaultVal="${zmlLoanContractPage.repayStatus}" hasLabel="false"  title="还款状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="loanFrequency" name="loanFrequency" type="text" style="width: 150px" class="inputxt" value='${zmlLoanContractPage.loanFrequency}'>
				<span class="Validform_checktip"></span>
