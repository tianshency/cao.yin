...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zmlLoanPayLoanInfoController.do?doAdd" >
	<input id="contractId" name="contractId" type="hidden" value="${zmlLoanContract.id }">
	<input id="applId" name="applId" type="hidden" value="${zmlLoanContract.applId }">
	<input id="userId" name="userId" type="hidden" value="${zmlLoanContract.userId }">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
			    <input id="payLoanNum" name="contractNo" type="text" style="width: 150px" class="inputxt" value="${zmlLoanContract.contractNo }">
			</td>
			<td align="right">
