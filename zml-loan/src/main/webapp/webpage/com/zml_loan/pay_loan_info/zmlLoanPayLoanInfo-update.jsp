...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zmlLoanPayLoanInfoController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					<t:dictSelect field="contractId" type="list"
						dictTable="zml_loan_contract" dictField="id" dictText="contract_no" defaultVal="${zmlLoanPayLoanInfoPage.contractId}" hasLabel="false"  title="合同"></t:dictSelect>     
			...
			<td class="value">
					<t:dictSelect field="applId" type="list"
						dictTable="zml_loan_application" dictField="id" dictText="subject" defaultVal="${zmlLoanPayLoanInfoPage.applId}" hasLabel="false"  title="申请"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="userId" type="list"
						dictTable="zml_user" dictField="id" dictText="real_name" defaultVal="${zmlLoanPayLoanInfoPage.userId}" hasLabel="false"  title="用户"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="payLoanNum" name="payLoanNum" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.payLoanNum}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="productId" name="productId" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.productId}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="operatorId" type="list"
						dictTable="t_s_base_user" dictField="id" dictText="realname" defaultVal="${zmlLoanPayLoanInfoPage.operatorId}" hasLabel="false"  title="操作人ID"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="currency" type="list"
						typeGroupCode="currency" defaultVal="${zmlLoanPayLoanInfoPage.currency}" hasLabel="false"  title="币种"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="payDate" name="payDate" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${zmlLoanPayLoanInfoPage.payDate}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="arriveDate" name="arriveDate" type="text" style="width: 150px" 
		      						class="Wdate" onClick="WdatePicker()"  value='<fmt:formatDate value='${zmlLoanPayLoanInfoPage.arriveDate}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="contractRate" name="contractRate" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.contractRate}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="overduerate" name="overduerate" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.overduerate}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="contractAmt" name="contractAmt" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.contractAmt}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fee" name="fee" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.fee}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="payAmt" name="payAmt" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.payAmt}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="status" type="list"
						typeGroupCode="pay_sts" defaultVal="${zmlLoanPayLoanInfoPage.status}" hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="payLoanIndex" name="payLoanIndex" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.payLoanIndex}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="isUpload" type="list"
						typeGroupCode="sf_yn" defaultVal="${zmlLoanPayLoanInfoPage.isUpload}" hasLabel="false"  title="是否上传借据"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="loanPremium" name="loanPremium" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.loanPremium}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="paymentType" type="list"
						typeGroupCode="payment_type" defaultVal="${zmlLoanPayLoanInfoPage.paymentType}" hasLabel="false"  title="付款类型"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="bankName" name="bankName" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.bankName}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bankAddressProvince" name="bankAddressProvince" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.bankAddressProvince}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="bankAddressCity" name="bankAddressCity" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.bankAddressCity}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="bankBranch" name="bankBranch" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.bankBranch}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="accountNumber" name="accountNumber" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.accountNumber}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="tradeNo" name="tradeNo" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.tradeNo}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="remarks" name="remarks" type="text" style="width: 150px" class="inputxt" value='${zmlLoanPayLoanInfoPage.remarks}'>
				<span class="Validform_checktip"></span>
