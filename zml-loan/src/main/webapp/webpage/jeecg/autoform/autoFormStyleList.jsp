...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="autoFormStyleList" checkbox="true" fitColumns="false" title="formstyle.title" actionUrl="autoFormStyleController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="common.delete" url="autoFormStyleController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   ...
   <t:dgToolBar title="common.view" icon="icon-search" url="autoFormStyleController.do?goUpdate" funname="detail" width="100%" height="100%"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
