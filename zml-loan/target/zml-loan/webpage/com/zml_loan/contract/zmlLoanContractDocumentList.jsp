		...
		<c:forEach items="${zmlLoanContractDocumentList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
				   ...
				   <td align="left">
							<t:dictSelect field="zmlLoanContractDocumentList[${stuts.index }].approvalUserId" type="list"
				   ...
				   <td align="left">
					      	<input name="zmlLoanContractDocumentList[${stuts.index }].approvalDate" maxlength="20" 
