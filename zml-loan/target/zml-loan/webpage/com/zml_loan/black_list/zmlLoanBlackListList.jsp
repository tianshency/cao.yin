...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zmlLoanBlackListList" checkbox="true" fitColumns="false" title="黑名单" actionUrl="zmlLoanBlackListController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="zmlLoanBlackListController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="zmlLoanBlackListController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="zmlLoanBlackListController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="zmlLoanBlackListController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="zmlLoanBlackListController.do?goUpdate" funname="detail"></t:dgToolBar>
