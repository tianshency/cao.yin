...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
   ...
   <t:dgDelOpt title="common.delete" url="autoFormDbController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgFunOpt title="form.db.preview" funname="goView(id)" urlclass="ace_button"  urlfont="fa-search"></t:dgFunOpt>
   ...
   <t:dgToolBar title="common.view" icon="icon-search" url="autoFormDbController.do?goUpdate" funname="detail"></t:dgToolBar>
 ...
 <script src = "webpage/jeecg/autoform/autoFormDbList.js"></script>		
