 ...
 *
 */
public class ZmlPlatformOrderPage implements java.io.Serializable {
	/**主键*/
	...
	/**保存-对应商品*/
    @ExcelCollection(name="对应商品")
	private List<ZmlPlatformOrderCommodityEntity> zmlPlatformOrderCommodityList = new ArrayList<ZmlPlatformOrderCommodityEntity>();
		public List<ZmlPlatformOrderCommodityEntity> getZmlPlatformOrderCommodityList() {
		return zmlPlatformOrderCommodityList;
		}
		public void setZmlPlatformOrderCommodityList(List<ZmlPlatformOrderCommodityEntity> zmlPlatformOrderCommodityList) {
		this.zmlPlatformOrderCommodityList = zmlPlatformOrderCommodityList;
		}
	/**保存-对应用户订单*/
    @ExcelCollection(name="对应用户订单")
	private List<ZmlPorderToCorderEntity> zmlPorderToCorderList = new ArrayList<ZmlPorderToCorderEntity>();
		public List<ZmlPorderToCorderEntity> getZmlPorderToCorderList() {
		return zmlPorderToCorderList;
		}
		public void setZmlPorderToCorderList(List<ZmlPorderToCorderEntity> zmlPorderToCorderList) {
		this.zmlPorderToCorderList = zmlPorderToCorderList;
		}
}
