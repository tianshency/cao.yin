 ...
 */
@Entity
@Table(name = "zml_user_pay_turnover", schema = "")
@SuppressWarnings("serial")
public class ZmlUserPayTurnoverEntity implements java.io.Serializable {
	/**主键*/
	...
	/**付款金额*/
	@Excel(name="付款金额")
	private java.lang.String payAmout;
	/**状态*/
	@Excel(name="状态")
	 ...
	 */
	@Column(name ="PAY_WAY",nullable=true,length=2)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  支付方式名称
	 */
	@Column(name ="PAY_NAME",nullable=true,length=50)
	 ...
	 */
	@Column(name ="TOTAL_AMOUNT",nullable=true,scale=2,length=14)
	...
	public java.lang.String getPayAmout(){
	 ...
	 */
	public void setPayAmout(java.lang.String payAmout){
