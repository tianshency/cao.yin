 ...
 */
@Entity
@Table(name = "zml_user_release_territory", schema = "")
@SuppressWarnings("serial")
public class ZmlUserReleaseTerritoryEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="RELEASE_TYPE",nullable=true,length=36)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  面积
	 */
	@Column(name ="AREA",nullable=true,scale=2,length=14)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  土地类型
	 */
	@Column(name ="LAND_TYPE",nullable=true,length=2)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  地势
	 */
	@Column(name ="TERRAIN",nullable=true,length=2)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  地势
	 */
	public void setTerrain(java.lang.String terrain){
	 ...
	 */
	@Column(name ="VALID_START_DATE",nullable=true,length=10)
	 ...
	 */
	@Column(name ="VALID_END_DATE",nullable=true,length=10)
