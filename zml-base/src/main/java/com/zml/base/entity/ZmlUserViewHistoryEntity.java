 ...
 */
@Entity
@Table(name = "zml_user_view_history", schema = "")
@SuppressWarnings("serial")
public class ZmlUserViewHistoryEntity implements java.io.Serializable {
	/**主键*/
	...
	/**浏览次数*/
	@Excel(name="浏览次数")
	private java.lang.Integer browsingTimes;
	/**浏览次数*/
	@Excel(name="状态")
	 ...
	 */
	@Column(name ="VIEW_TYPE",nullable=true,length=2)
	 ...
	 */
	@Column(name ="BROWSING_TIMES",nullable=true,length=10)
	public java.lang.Integer getBrowsingTimes(){
	 ...
	 */
	public void setBrowsingTimes(java.lang.Integer browsingTimes){
