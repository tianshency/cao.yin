 ...
 */
@Entity
@Table(name = "zml_loan_lan_info", schema = "")
@SuppressWarnings("serial")
public class ZmlLoanLanInfoEntity implements java.io.Serializable {
	/**主键*/
	...
	/**土地类型*/
	@Excel(name="土地类型")
	private java.lang.String lanType;
	/**总面积*/
	@Excel(name="总面积")
	 ...
	 */
	@Column(name ="LAN_TYPE",nullable=true,length=1)
	public java.lang.String getLanType(){
		return this.lanType;
	}
	 ...
	 */
	public void setLanType(java.lang.String lanType){
