 ...
 *
 */
public class ZmlLoanPayLoanInfoPage implements java.io.Serializable {
	/**主键*/
	...
	/**保存-放款文档*/
    @ExcelCollection(name="放款文档")
	private List<ZmlLoanPayDocumentEntity> zmlLoanPayDocumentList = new ArrayList<ZmlLoanPayDocumentEntity>();
		public List<ZmlLoanPayDocumentEntity> getZmlLoanPayDocumentList() {
		return zmlLoanPayDocumentList;
		}
		public void setZmlLoanPayDocumentList(List<ZmlLoanPayDocumentEntity> zmlLoanPayDocumentList) {
		this.zmlLoanPayDocumentList = zmlLoanPayDocumentList;
		}
}
