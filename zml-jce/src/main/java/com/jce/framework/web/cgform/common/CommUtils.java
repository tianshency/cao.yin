package com.jce.framework.web.cgform.common;
...
public class CommUtils {
    ...
    public static void main(String[] args) {
    	...
    	com.jce.framework.core.util.LogUtil.info(strs.length+"");
    	com.jce.framework.core.util.LogUtil.info(strs[0].substring(0,strs[0].indexOf("[")));
	}
}
