...
public class DemoController extends BaseController {
	...
	public ModelAndView aorudemo(TSDemo demo, HttpServletRequest request) {
		...
		if (type.equals("table")) {
			return new ModelAndView("sys/demo/base/tabledemo");
		} else if(type.equals("tableupdate")){
			return new ModelAndView("sys/demo/base/demoTab");
		}else{
			return new ModelAndView("sys/demo/base/demo");
		}
	...
	public ModelAndView demoIframe(HttpServletRequest request) {
		...
		return new ModelAndView("sys/demo/base/demoIframe");
	}
	...
	public ModelAndView demoList(HttpServletRequest request) {
		return new ModelAndView("sys/demo/base/demoList");
	}
	...
	public ModelAndView demoCode(TSDemo demo, HttpServletRequest request) {
		...
		demo = list.get(0);
		request.setAttribute("demo", demo);
		return new ModelAndView("sys/demo/base/democode");
	}
	...
	public ModelAndView uploadTabs(HttpServletRequest request) {
		return new ModelAndView("sys/demo/base/upload/uploadTabs");
	}
	/**
	 * 图片预览TABS跳转
	 */
	...
	public ModelAndView imgViewTabs(HttpServletRequest request) {
		return new ModelAndView("sys/demo/base/picview/imgViewTabs");
	}
	/**
	 * 表单验证TABS跳转
	 */
	...
	public ModelAndView formTabs(HttpServletRequest request) {
		return new ModelAndView("sys/demo/base/formvalid/formTabs");
	}
	/**
	 * 动态模板TABS跳转
	 */
	...
	public ModelAndView templeteTabs(HttpServletRequest request) {
		return new ModelAndView("sys/demo/base/template/templateiframe");
	}
	/**
	 * 上传演示
	 */
	...
	public ModelAndView autoupload(HttpServletRequest request) {
		...
		return new ModelAndView("sys/demo/base/"+turn+"");
	}
	...
	public ModelAndView select(HttpServletRequest request) {
		...
		return new ModelAndView("sys/demo/base/AJAX/select");
	}
	/**
	 *数据字典下拉
	 */
	...
	public ModelAndView dictSelect(HttpServletRequest request) {
		...
		return new ModelAndView("sys/demo/base/dict/dictSelect");
	}
	/**
	 * 地图demo
	 * @param request
	...
	public ModelAndView mapDemo(HttpServletRequest request) {
		return new ModelAndView("sys/demo/base/map/mapDemo2");
	}
	/**
	 * 保存DEMO维护
	 * 
	...
	public ModelAndView demoLayout(HttpServletRequest request) {
		...
		List<TSDemo> demoList = systemService.getListByCriteriaQuery(cq, false);
		request.setAttribute("demoList", demoList);
		return new ModelAndView("sys/demo/base/layout/demoLayoutList");
	}
	...
	public ModelAndView aorudemoLayout(TSDemo demo, HttpServletRequest request) {
		...
		return new ModelAndView("sys/demo/base/layout/demoLayout");

	}

	@RequestMapping(params = "eSign")
	public ModelAndView eSignDemo(HttpServletRequest request) {
		return new ModelAndView("sys/demo/test/zsign");
	}
