...
import com.jce.framework.web.system.dao.JeecgDictDao;
...
import com.jce.framework.web.system.pojo.base.TSIcon;
import com.jce.framework.web.system.pojo.base.TSLog;
...
public class SystemServiceImpl extends CommonServiceImpl implements SystemService {
	 ...
	 * 添加日志
	 */
	public void addLog(String url, String functionId, String logcontent, Short loglevel, Short operatetype) {
	...
	@Override
	public List<Map<String, Object>> headlinesList() {
		String sql = "select t.id, t.notice_title noticeTitle, t.create_time createTime ,1 type "
	            + "from t_s_notice t  ";
		sql += " ORDER BY t.create_time desc limit 6";
