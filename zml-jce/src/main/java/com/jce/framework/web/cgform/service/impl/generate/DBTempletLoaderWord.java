package com.jce.framework.web.cgform.service.impl.generate;
...
public class DBTempletLoaderWord implements TemplateLoader {
    ...
    public Object findTemplateSource(String name) throws IOException {
		...
		//update by Robin postgreSQL 修正大小写的问题 2013-03-13
    	com.jce.framework.core.util.LogUtil.info("table name----------->"+name);
...
//	    		com.jce.framework.core.util.LogUtil.info(content);
...
//				e.printStackTrace();
//			}
//			com.jce.framework.core.util.LogUtil.info("current path :" + path);
//		}
