package com.jce.framework.web.cgform.controller.cgformftl;
...
import com.jce.framework.core.util.FormUtil;
...
import com.jce.framework.web.cgform.common.OfficeHtmlUtil;
import com.jce.framework.web.cgform.engine.TempletContext;
import com.jce.framework.web.cgform.entity.cgformftl.CgformFtlEntity;
...
public class CgformFtlController extends BaseController {
	...
	public ModelAndView ckeditor(HttpServletRequest request, String id) {
		...
		if(request.getParameter("editorType")==null){
			return new ModelAndView("sys/cgform/cgformftl/ckeditor");
		}else{
			return new ModelAndView("sys/cgform/cgformftl/"+request.getParameter("editorType"));
		}
	}
	...
	public ModelAndView cgformFtl(HttpServletRequest request) {
		...
		return new ModelAndView("sys/cgform/cgformftl/cgformFtlList");
	}
	...
	public ModelAndView addorupdate(CgformFtlEntity cgformFtl,
		...
		if("02".equals(cgformFtl.getEditorType())){
			return new ModelAndView("sys/cgform/cgformftl/cgformFtlUEditor");
		}else if("03".equals(cgformFtl.getEditorType())){
			return new ModelAndView("sys/cgform/cgformftl/cgformFtl");
		}else{
			return new ModelAndView("sys/cgform/cgformftl/cgformFtlEditor");
		}
	}
	...
	public ModelAndView cgformFtl2(HttpServletRequest request) {
		String formid = request.getParameter("formid");
		request.setAttribute("formid", formid);
		return new ModelAndView("sys/cgform/cgformftl/cgformFtlList2");
	}
