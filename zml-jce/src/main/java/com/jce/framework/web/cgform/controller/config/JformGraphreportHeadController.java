...
import com.jce.framework.web.cgform.entity.config.JformGraphreportHeadPage;
import com.jce.framework.web.cgform.entity.config.JformGraphreportItemEntity;
import com.jce.framework.web.cgform.service.config.JformGraphreportHeadServiceI;
...
public class JformGraphreportHeadController extends BaseController {
	...
	public ModelAndView jformGraphreportHead(HttpServletRequest request) {
		return new ModelAndView("sys/cgform/graphreport/jformGraphreportHeadList");
	}
	...
	public void datagrid(JformGraphreportHeadEntity jformGraphreportHead,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.jce.framework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, jformGraphreportHead);
		try{
		//自定义追加查询条件
		}catch (Exception e) {
	...
	public ModelAndView goAdd(JformGraphreportHeadEntity jformGraphreportHead, HttpServletRequest req) {
		...
		return new ModelAndView("sys/cgform/graphreport/jformGraphreportHead-add");
	}
	...
	public ModelAndView goUpdate(JformGraphreportHeadEntity jformGraphreportHead, HttpServletRequest req) {
		...
		return new ModelAndView("sys/cgform/graphreport/jformGraphreportHead-update");
	}
	...
	public ModelAndView jformGraphreportItemList(JformGraphreportHeadEntity jformGraphreportHead, HttpServletRequest req) {
		...
		return new ModelAndView("sys/cgform/graphreport/jformGraphreportItemList");
	}
	...
	public String goImportExcel(){
		return "sys/cgform/graphreport/jformGraphreportUpload";
	}
