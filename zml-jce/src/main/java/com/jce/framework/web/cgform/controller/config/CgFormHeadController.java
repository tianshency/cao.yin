package com.jce.framework.web.cgform.controller.config;
...
import com.jce.framework.web.cgform.engine.TempletContext;
import com.jce.framework.web.cgform.entity.config.CgFormFieldEntity;
import com.jce.framework.web.cgform.entity.config.CgFormFieldVO;
...
import com.jce.framework.web.cgform.exception.BusinessException;
import com.jce.framework.web.cgform.service.config.CgFormFieldServiceI;
import com.jce.framework.web.cgform.service.config.CgFormIndexServiceI;
import com.jce.framework.web.cgform.service.impl.config.util.FieldNumComparator;
...
public class CgFormHeadController extends BaseController {
	...
	public ModelAndView cgFormHeadList(HttpServletRequest request) {
		return new ModelAndView("sys/cgform/config/cgFormHeadList");
	}
	/**
	 * 提供选择的界面
	 * @param request
	...
	public ModelAndView cgForms(HttpServletRequest request) {
		return new ModelAndView("sys/cgform/config/cgForms");
	}
	@RequestMapping(params = "goCgFormSynChoice")
	public ModelAndView goCgFormSynChoice(HttpServletRequest request) {
		return new ModelAndView("sys/cgform/config/cgformSynChoice");
	}
	...
	public ModelAndView popmenulink(ModelMap modelMap,
		...
		return new ModelAndView("sys/cgform/config/popmenulink");
	}
	...
	public ModelAndView addorupdate(CgFormHeadEntity cgFormHead,
		...
		return new ModelAndView("sys/cgform/config/cgFormHead");
	}
	/**
	 * 获取表格具体的属性列
	 * 
...
//			columnList.add(field);
	...
	public ModelAndView sqlPlugin(String id,HttpServletRequest request) {
		...
		return new ModelAndView("sys/cgform/config/cgFormSqlPlugin");
	}
	/**
	 * sql 插件保存
	 * @param id 配置id
	...
	public ModelAndView jsPlugin(String id,HttpServletRequest request) {
		CgFormHeadEntity bean = cgFormFieldService.getEntity(
				CgFormHeadEntity.class, id);
		request.setAttribute("bean", bean);
		return new ModelAndView("sys/cgform/config/cgFormJsPlugin");
	}
	/**
	 * js 插件保存
	 * @param id 配置id
	...
	public String upload(String id,HttpServletRequest request) {
		...
		return "sys/cgform/config/cgformColUpload";
	}
