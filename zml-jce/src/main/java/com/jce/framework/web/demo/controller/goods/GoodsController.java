package com.jce.framework.web.demo.controller.goods;
...
import com.jce.framework.web.demo.entity.goods.GoodsEntity;
import com.jce.framework.web.demo.service.goods.GoodsServiceI;
...
public class GoodsController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("sys/demo/goods/goodsList");
	}
	...
	public void datagrid(GoodsEntity goods,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.jce.framework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, goods, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
	...
	public ModelAndView goAdd(GoodsEntity goods, HttpServletRequest req) {
		...
		return new ModelAndView("sys/demo/goods/goods-add");
	}
	/**
	 * 商品资料编辑页面跳转
	 * 
	...
	public ModelAndView goUpdate(GoodsEntity goods, HttpServletRequest req) {
		...
		return new ModelAndView("sys/demo/goods/goods-update");
	}
	/**
	 * 商品信息Info页面跳转
	 * 
	...
	public ModelAndView goInfo(GoodsEntity goods, HttpServletRequest req) {
		...
		return new ModelAndView("sys/demo/goods/goods-info");
	}
	/**
	 * 导入功能跳转
	 * 
