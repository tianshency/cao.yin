...
import com.jce.framework.core.common.model.json.ValidForm;
import com.jce.framework.core.constant.Globals;
import com.jce.framework.core.extend.hqlsearch.parse.ObjectParseUtil;
import com.jce.framework.core.extend.hqlsearch.parse.PageValueConvertRuleEnum;
import com.jce.framework.core.extend.hqlsearch.parse.vo.HqlRuleEnum;
import com.jce.framework.core.util.DateUtils;
import com.jce.framework.core.util.JSONHelper;
import com.jce.framework.core.util.ListUtils;
import com.jce.framework.core.util.MutiLangSqlCriteriaUtil;
import com.jce.framework.core.util.MutiLangUtil;
import com.jce.framework.core.util.MyClassLoader;
import com.jce.framework.core.util.ResourceUtil;
import com.jce.framework.core.util.SetListSort;
import com.jce.framework.core.util.StringUtil;
import com.jce.framework.core.util.YouBianCodeUtil;
...
import com.jce.framework.web.system.manager.ClientSort;
import com.jce.framework.web.system.pojo.base.Client;
import com.jce.framework.web.system.pojo.base.DataLogDiff;
import com.jce.framework.web.system.pojo.base.TSDatalogEntity;
...
import com.jce.framework.web.system.pojo.base.TSRole;
import com.jce.framework.web.system.pojo.base.TSRoleFunction;
import com.jce.framework.web.system.pojo.base.TSType;
import com.jce.framework.web.system.pojo.base.TSTypegroup;
import com.jce.framework.web.system.pojo.base.TSVersion;
import com.jce.framework.web.system.service.MutiLangServiceI;
...
//        add-end--Author:zhangguoming  Date:20140929 for：数据字典修改
	...
	public AjaxJson saveDepart(TSDepart depart, HttpServletRequest request) {
		...
		MultipartFile  logoFile = mrequest.getFile("logo");
...
//			depart.setOrgCode(orgCode);
    ...
    public ModelAndView commonUpload(HttpServletRequest req) {
    	...
    	if("commodity".equals(type)){
    		return new ModelAndView("common/upload/uploadCommodityView");
    	}else
    ...
    public void dataLogDatagrid(TSDatalogEntity datalogEntity,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid){
		...
		//查询条件组装器
		com.jce.framework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, datalogEntity, request.getParameterMap());
		cq.add();
		this.systemService.getDataGridReturn(cq, true);
		TagUtil.datagrid(response, dataGrid);
    }
	...
	@RequestMapping(params = "toRefreshPage")
	public String toRefreshPage(){
		
		return "system/mng/refreshPage";
	}
	//add-end--Author:  for：增加数据日志Diff功能
	//刷新redis缓存
	@RequestMapping(params = "refreshRedis")
	@ResponseBody
    public AjaxJson refreshRedis(){
    	AjaxJson j = new AjaxJson();
    	//查询公告 信息
    	List<Map<String,Object>> headlinesList = this.systemService.headlinesList();
