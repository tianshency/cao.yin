...
import com.jce.framework.web.cgform.engine.FreemarkerHelper;
...
import com.jce.framework.web.demo.entity.test.CKEditorEntity;
...
import com.jce.framework.web.demo.entity.test.JeecgMatterBom;
import com.jce.framework.web.demo.entity.test.JeecgNoteEntity;
...
import com.jce.framework.web.demo.entity.test.TSStudent;
import com.jce.framework.web.demo.entity.test.TeacherEntity;
import com.jce.framework.web.system.dao.repair.RepairDao;
import com.jce.framework.web.system.pojo.base.*;
import com.jce.framework.web.system.service.RepairService;
...
//		approver.setTSDepart(eiu);
	...
	private void repaireIcon() {
		com.jce.framework.core.util.LogUtil.info("修复图标中");
	...
	private void repairMenu() {
		...
		TSIcon folder = commonDao.findByProperty(TSIcon.class, "iconName",
				"文件夹").get(0);
		com.jce.framework.core.util.LogUtil.info(defaultIcon.getIconPath());
