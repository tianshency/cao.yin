package com.jce.framework.core.common.service.impl;
...
import com.jce.framework.tag.vo.easyui.Autocomplete;
...
public class CommonServiceImpl implements CommonService {
	...
	public List<Map<String, String>> uploadFile(UploadFile uploadFile, String dirName, String id) {
		return commonDao.uploadFile(uploadFile, dirName, id);
	}
