package com.jce.framework.core.constant;
...
public final class Globals {
	...
	public static final Short Log_Leavel_ERROR=3;
	 ...
	 public static final Short Log_Type_Loan_Approve=50; //贷款审批
	 public static final Short Log_Type_Contract_Approve=55; //合同审批
	 
	 public static final Short APP_Log_Type_INSERT=8; //APP 端插入
	 public static final Short APP_Log_Type_DEL=9; //APP 端删除
	 public static final Short APP_Log_Type_UPDATE=10; //APP 端更新
	 
	 public static final Short APP_Log_Type_ORDER_SETT=11; //APP 订单去结算
	 public static final Short APP_Log_Type_INSERT_ORDER=12; //插入订单
	 
	 public static final Short APP_Log_Type_Cancel_Attention=101; //取消关注
