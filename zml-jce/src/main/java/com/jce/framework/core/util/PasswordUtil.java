...
public class PasswordUtil {
	...
	public static String getMD5Pwd(String pwd) {
        ...
        return "R:" + GenerateNo.getRandomNum(12);
    }
	public static void main(String[] args) {
		...
		com.jce.framework.core.util.LogUtil.info("明文:" + str);
		com.jce.framework.core.util.LogUtil.info("密码:" + password);

		try {
			byte[] salt = PasswordUtil.getStaticSalt();
			String ciphertext = PasswordUtil.encrypt(str, password, salt);
			com.jce.framework.core.util.LogUtil.info("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
			com.jce.framework.core.util.LogUtil.info("明文:" + plaintext);
			
			String result = PasswordUtil.decrypt("ea3d519525358e00", "root", salt);
			com.jce.framework.core.util.LogUtil.info("明文:" + result);
		} catch (Exception e) {
			e.printStackTrace();
		}
		*/
		String rs = PasswordUtil.getMD5Pwd("13260111955");
		System.out.println("rs===" + rs);
		
		String password = PasswordUtil.encrypt("18600640229", "640229", PasswordUtil.getStaticSalt());
