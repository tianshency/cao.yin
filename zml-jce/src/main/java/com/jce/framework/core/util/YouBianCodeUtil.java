...
//			 com.jce.framework.core.util.LogUtil.info(after_code);
//			 com.jce.framework.core.util.LogUtil.info(after_code_zimu);
//			 com.jce.framework.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// com.jce.framework.core.util.LogUtil.info(getNextZiMu('C'));
		// com.jce.framework.core.util.LogUtil.info(getNextNum(8));
		com.jce.framework.core.util.LogUtil.info(getSubYouBianCode("C99A01","B03"));
//		com.jce.framework.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
